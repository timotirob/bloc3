...
. Dans un fichier `server-sessions.js`, reproduisez l'un des deux exemples ci-dessus.
...
.Aide (structure du fichier `server-sessions.js`)
[source,javascript]
----
...
Dans votre fichier `server-sessions.js`, importez ce tableau au début du fichier.
[source,javascript]
----
...
[source,javascript]
----
// Au début de votre fichier server-sessions.js, après const app = express();
...
[source,javascript]
----
// Au début de server-sessions.js
