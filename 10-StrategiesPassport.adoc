...
Il faut également tester avec un utilisateur normal, enregistrement et login. Comment rendre cet utilisateur admin ? Donnez le droit admin à un utilisateur lambda et tester.
